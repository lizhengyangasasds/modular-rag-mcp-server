...
def _register_builtin_providers() -> None:
    ...
    try:
        from src.libs.embedding.huggingface_embedding import HuggingFaceEmbedding
        EmbeddingFactory.register_provider("huggingface", HuggingFaceEmbedding)
        EmbeddingFactory.register_provider("local", HuggingFaceEmbedding)  # Alias for backwards compatibility
    except ImportError:
        pass  # HuggingFace provider not available
